...
export function WorkspacePage({ user }: { user: User }) {
  ...
  const { status: notificationStatus, latestPost, listenerError, requestPermission, sendTestNotification } = usePostNotifications();
