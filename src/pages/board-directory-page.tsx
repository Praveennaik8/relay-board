...
function CreateBoardDialog() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    setSubmitting(true);
    try {
      const { boardId } = await createBoard(name, accessCode);
      setOpen(false);
